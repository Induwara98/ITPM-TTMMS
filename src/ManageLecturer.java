...
public class ManageLecturer {
	...
	private void initialize() {
		...
		cbFac.setModel(new DefaultComboBoxModel(new String[] {"Select", "IT", "Engineering", "Business Management"}));
		...
		cbDepartment.setModel(new DefaultComboBoxModel(new String[] {"Select", "SE", "Network", "Cyber", "IT", "IM"}));
